...
`ggml-large-v3-turbo-q8_0.bin` if you want higher accuracy and can
afford the latency.

```bash
cd automatic-speech-recognition

# Download the model into ./models (~250 MB)
...
First boot loads the model (~3 s for small q8_0 on CPU).
